    ...
    <li className="nav-item px-4 cursor-pointer" onClick={cb(toggle, tabIndex)}>
      <span
        className={classNames(
          "block nav- font-bold text-sm leading-tight border-x-0 border-t-0 border-b-2 border-transparent py-2 my-2 hover:border-transparent focus:border-transparent",
          {
