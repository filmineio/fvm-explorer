...
export const TransactionActors = ({
  ...
  return (
    <div className="xs:flex mt-3 flex-wrap justify-center sm:justify-start items-center">
      <button className="bg-secect mb-2 py-2 px-3 rounded-base text-analogous font-bold font-mono1 text-sm	tracking-wider	leading-5 relative">
      ...
      <button className="bg-secect mb-2  py-2 px-3 rounded-base text-yellow font-bold font-mono1 text-sm	tracking-wider	leading-5 relative">
