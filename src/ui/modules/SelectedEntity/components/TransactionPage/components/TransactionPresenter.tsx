...
export const TransactionPresenter = ({
  ...
  return (
    ...
    >
      ...
      <div className="bg-slate text-center text-white text-smt ext-white tracking-wider font-light whitespace-nowrap w-48">
        {value.toFixed()} FIL
      </div>
      <div className="bg-slate text-sm text-right text-white rounded-r-lg text-white tracking-wider font-lightpy-3 whitespace-nowrap w-48">
