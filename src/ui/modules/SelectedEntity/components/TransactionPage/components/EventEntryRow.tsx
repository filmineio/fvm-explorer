  ...
  return (
    <tr className={"max-w-xl"}>
      ...
      <td>
        ...
        {/*<select className=" text-yellow select-text border-none focus:outline-none focus:border-none bg-inherit  caret-yellow text-14	font-semibold tracking-wide	cursor-pointer">*/}
